...
<body>
    ...
    <div class="header">
        ...
        <a href="bookingfetch.php"><button class="adm-tool">booking</button></a>
            ...
            <button onclick="Update()" class="adm-update">payments</button>
    ...
    <div class="container">
        ...
        while ($r = mysqli_fetch_array($results)) {
            $status = ($r['status'] == 1) ? 'approved' : 'unapproval';
            echo "<tr>
                    <td>" . $r['comeid'] . "</td>
                    <td>" . $r['name'] . "</td>
                    <td>" . $r['email'] . "</td>
                    ...
                    <td>" . $r['datetime'] . "</td>
                    <td>" . $status . "</td>
                    <td><a href='viewclients.php?userid=$r[comeid]' onclick='toggleView()'><button>View</button></a></td>
                    <td><button>Edit</button></td>
                    <td><a href='clientsapproval.php?userid=$r[comeid]'><button>Deactivate</button></a></td>
