...
if ($r = mysqli_fetch_array($results)) {
    ...
    echo '</tr>';
    echo '<tr>';
    echo '<td><label for="name">Services:</label></td>';
    ...
    echo '<td><label for="name">password:</label></td>';
    echo '</tr>';
    echo '<tr>';
    echo '<td><label for="name">created date:</label></td>';
    ...
    echo '<button type="button" class="approval-btn" onclick="approveProperty(' . $r["comeid"] . ')">approval</button>';
}
?>
    </div>
    ...
    <script>
        function approveProperty(propertyId) {
            var confirmation = confirm("Are you sure you want to approve this him?");
            if (confirmation) {
                fetch('clientsapprovalprocess.php', {
                    method: 'POST',
                    headers: {
                    ...
                    .then(data => {
                        if (data.success) {
                            alert('you are sure i want to approval.');
                        } else {
